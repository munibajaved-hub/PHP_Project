...
<!-- Hero Section Begin -->
    ...
    <section class="breadcrumb-section set-bg" data-setbg="../assets/user/img/breadcrumb.jpg">
        <div class="container">
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="../uploads/<?php echo $prodrow['image']; ?>" alt="">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">
                            RS: <span id = "total-price"><?php echo $prodrow['price'] ?></span>
                        </div>
                        <p><?php echo $prodrow['description'] ?></p>
                        <div class="product__details__quantity">
                            <div class="quantity">
                                <div class="pro-qty">
                                    <input type="text" id ="product-qty" value="1" data-price = "<?php echo $prodrow['price'] ?>">
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Template ke buttons (.qtybtn) par click ko handle karne ke liye
    $(document).on('click', '.qtybtn', function() {
        // Thoda sa delay taake template ki apni script value update kar de
        setTimeout(function() {
    ...
    // Agar user keyboard se value change kare
